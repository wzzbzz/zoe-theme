...
function qode_child_theme_enqueue_scripts() {
    ...
    wp_enqueue_script( 'site-js', get_stylesheet_directory_uri() . '/site.js', 'jquery', '1', true );
...
function mga_get_blog_posts($url) {
    $ch = curl_init();
    $timeout = 5;
...
function mga_sort_objects_by_total($a, $b) {
